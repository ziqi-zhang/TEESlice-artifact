...
for VICTIM_ARCH in [
	...
	for TASK in [
		...
		cmd = (f"CUDA_VISIBLE_DEVICES={GPU} "
			f"python knockoff/nettailor_face/distill_teacher.py "
			f"--task {TASK} "
		...
		cmd = (f"CUDA_VISIBLE_DEVICES={GPU} "
			f"python knockoff/nettailor_face/nettailor_student.py "
			f"--task {TASK} "
		...
		cmd = (f"CUDA_VISIBLE_DEVICES={GPU} "
			f"python3 knockoff/nettailor_face/nettailor_iterative.py "
			f"--task {TASK} "
