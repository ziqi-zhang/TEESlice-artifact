...
def main():
    ...
    if args.graybox_mode == "fc":
        graybox_model.reinit_fc()
    elif args.graybox_mode == "layer4":
        graybox_model.reinit_fc()
        graybox_model.reinit_layer4(pretrained)
    elif args.graybox_mode == "lastconv":
        graybox_model.reinit_fc()
        graybox_model.reinit_lastconv(pretrained)
    else:
    ...
    for b in budgets:
        ...
        optimizer = get_optimizer(graybox_model.parameters(), params['optimizer_choice'], **params)
        print(params)
