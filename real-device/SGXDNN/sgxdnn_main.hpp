...
extern "C" {
        ...
        void SecretInitQuantTensor(uint64_t TenId, void* voidDims);
        void SecretSetQuantTen(uint64_t TenId, void* voidArr); 
        void SecretGetQuantTen(uint64_t TenId, void* voidArr); 
        ...
        void quantrelu(uint64_t TenIdin, uint64_t TenIdout, uint64_t size, int exp, int bits);
