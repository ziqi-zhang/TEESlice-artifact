...
import nettailor.resnet_small as resnet_small
...
def eval_pretrained_model_time(
    ...
    pretrained = eval(f"resnet_small.{arch}")(pretrained=False)
    # pretrained = resnet_small.resnet34(pretrained=False)
    # pretrained = resnet_small.resnet50(pretrained=False)
    # pretrained = resnet_small.resnet101(pretrained=False)
    pretrained.eval()
...
if __name__=="__main__":
    ...
    parser.add_argument("--output_dir", default="nettailor/resnet_baseline")
