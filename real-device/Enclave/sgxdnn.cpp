...
void ecall_init_quant_tensor (uint64_t TenId, void* voidDims) {
    SecretInitQuantTensor(TenId, voidDims);
}
void ecall_set_quant_ten (uint64_t TenId, void* voidArr) {
    SecretSetQuantTen(TenId, voidArr);
}
void ecall_get_quant_ten (uint64_t TenId, void* voidArr) {
    SecretGetQuantTen(TenId, voidArr);
}
...
void ecall_quant_relu(uint64_t TenIdin, uint64_t TenIdout, uint64_t size, int exp, int bits){
    quantrelu(TenIdin, TenIdout, size, exp, bits);
}
