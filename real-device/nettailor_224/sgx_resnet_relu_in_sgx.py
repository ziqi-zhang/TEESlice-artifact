...
class SecretNNResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, batch_size=64, sid=0, EnclaveMode=ExecutionModeOptions.Enclave):
        ...
        self.sgx_layers = [
            self.input_layer, self.conv1, self.bn1, self.relu1,self.maxpool1
        ...
        self.layer1_blocks, self.layer1 = self._make_layer(
            block, 64, layers[0], sid=sid, prev_layer=self.maxpool1, name_prefix="Layer1", EnclaveMode=EnclaveMode)
...
if __name__=="__main__":
    ...
    GlobalTensor.init()
    resnet_constructor = secret_resnet18(EnclaveMode=ExecutionModeOptions.CPU)
