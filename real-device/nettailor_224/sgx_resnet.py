...
class SecretNNResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, batch_size=1, sid=0, EnclaveMode=ExecutionModeOptions.Enclave):
        self.inplanes = 64
...
if __name__=="__main__":
    ...
    GlobalTensor.init()
    resnet_constructor = secret_resnet18(EnclaveMode=ExecutionModeOptions.Enclave, batch_size=batch_size)
