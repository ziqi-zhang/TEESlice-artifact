...
class SecretNNVGG16BN(nn.Module):
    ...
    def __init__(self, num_classes=1000, batch_size=1, sid=0, EnclaveMode=ExecutionModeOptions.Enclave):
        ...
        self.relu1 = SecretReLULayer(sid, f"relu1", ExecutionModeOptions.Enclave)
        ...
        self.relu2 = SecretReLULayer(sid, f"relu2", ExecutionModeOptions.Enclave)
        ...
        self.relu3 = SecretReLULayer(sid, f"relu3", ExecutionModeOptions.Enclave)
        ...
        self.relu4 = SecretReLULayer(sid, f"relu4", ExecutionModeOptions.Enclave)
        ...
        self.relu5 = SecretReLULayer(sid, f"relu5", ExecutionModeOptions.Enclave)
        ...
        self.relu6 = SecretReLULayer(sid, f"relu6", ExecutionModeOptions.Enclave)
        ...
        self.relu7 = SecretReLULayer(sid, f"relu7", ExecutionModeOptions.Enclave)
        ...
        self.relu8 = SecretReLULayer(sid, f"relu8", ExecutionModeOptions.Enclave)
        ...
        self.relu9 = SecretReLULayer(sid, f"relu9", ExecutionModeOptions.Enclave)
        ...
        self.relu10 = SecretReLULayer(sid, f"relu10", ExecutionModeOptions.Enclave)
        ...
        self.relu11 = SecretReLULayer(sid, f"relu11", ExecutionModeOptions.Enclave)
        ...
        self.relu12 = SecretReLULayer(sid, f"relu12", ExecutionModeOptions.Enclave)
        ...
        self.relu13 = SecretReLULayer(sid, f"relu13", ExecutionModeOptions.Enclave)
...
if __name__=="__main__":
    ...
    resnet_constructor = secret_vgg16_bn(
        EnclaveMode=ExecutionModeOptions.GPU, 
    ...
    print(f"BS {batch_size}, ITER {iteration}, time {elapse:.4f}, throughput {throughput:.4f}")
